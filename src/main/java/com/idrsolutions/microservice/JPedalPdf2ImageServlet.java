...
@MultipartConfig
public class JPedalPdf2ImageServlet extends BaseServlet {

    private static final Logger LOG = Logger.getLogger(JPedalPdf2ImageServlet.class.getName());
    ...
    private static Encoder getEncoder(final String ext) {
        Encoder encoder;
        switch (ext) {
            case "bmp":
     ...
     * {@link JPedalPdf2ImageServlet#convertToPDF(File)}
     *
     * @param individual the individual object associated with this conversion
